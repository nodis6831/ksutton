...
/**
 * A class to compute the "Rolling Sixes" problem. The one commandline argument
	...
	public static void main(String[] args) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"You must input how many times you wish to roll the dice");
		}

		System.out
				.println("The ratio of the number of times one six was rolled out of six dice is "
						+ rollSixDice(numRolls)
						+ " out of "
						+ numRolls
						+ " rolls");
		System.out
				.println("The ratio of the number of times two sixes were rolled out of twelve dice is "
						+ rollTwelveDice(numRolls)
						+ " out of "
						+ numRolls
						+ " rolls");
	}
