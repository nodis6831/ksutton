...
/**
 * A program that takes in an int from the command-line and outputs the
 * probability of that many people plugged into the "Birthday Paradox" problem
 * 
 * @author Kelly Sutton
 */
public class BirthdayParadox {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("The estimated probability that two people will have the same birthday in a room of "
