...
/**
 * A (relatively) messy TrieNode class with built more built-in functionality
 * for computing the union of a document's alphabet and the frequency of the
 * characters. It's modified from my original TrieNode class from Problem Set #3
 * 
 * @author Kelly Sutton
 */
